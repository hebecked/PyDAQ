...
parser.add_argument( "Plot_data", "-P", list, group="config", default=True, help='Gives a live feedback plot of the current measurement.', multiargs=False, multiargsn=1, required=False)
